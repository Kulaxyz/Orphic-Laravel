    ...
    <div class="navbar-container navbar-offcanvas navbar-offcanvas-touch" id="js-bootstrap-offcanvas" style="margin-left: 0px; margin-right: 0px; padding-left: 0px; padding-right: 0px;">
      ...
      <ul class="site-menu" data-plugin="menu">
        ...
        <li class="site-menu-item hidden-md-up">
          ...
          {{-- News navbar --}}
          <li class="site-menu-item {{( URL::current() == url('blog') || URL::current() == url('category') ) ? 'active': '' }}">
                  <a class="category-menu-item in" href="#">
                      <span class="site-menu-title"><i class="site-menu-icon fa fa-newspaper" aria-hidden="true"></i>
                          {{ trans('general.news') }}
                      </span>
                  </a>
              <div class="coll">
                  <div class="menu-body">
                      <a href="{{ route('blog') }}">ALL ARTICLES</a>
        ...
        {{-- Faq navbar --}}
        <li class="site-menu-item {{( URL::current() == url('faqs') ) ? 'active': '' }}">
          <a href="{{ url('faqs')}}">
            <span class="site-menu-title"><i class="site-menu-icon fa fa-comments" aria-hidden="true"></i>{{ trans('general.faqs') }}</span>
          </a>
        </li>

        {{--Forum navbar--}}
        <li class="site-menu-item {{( URL::current() == url('forums') ) ? 'active': '' }}">
          <a href="{{ url('forums')}}">
            <span class="site-menu-title"><i class="site-menu-icon fab fa-foursquare" aria-hidden="true"></i>{{ trans('general.forums') }}</span>
          </a>
        </li>

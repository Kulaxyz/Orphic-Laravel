...
<html class="{{ strripos(Request::url(), 'forums') ? 'white-background' : '' }} no-js css-menubar{{ !Request::is('games') && !Request::is('listings') ? ' overflow-smooth' : '' }}{{ Request::is('messages') ? ' messages' : '' }}" lang="{{config('settings.default_locale')}}">
  <head>
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="{{ asset('css/navcat.css') }}">

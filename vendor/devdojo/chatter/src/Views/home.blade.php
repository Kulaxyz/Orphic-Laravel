	        	...
	        	<div class="panel">
                        ...
                        <form id="chatter_form_editor" action="/{{ Config::get('chatter.routes.home') }}/{{ Config::get('chatter.routes.discussion') }}" method="POST">
                            ...
                            <div id="editor">
                                @if( $chatter_editor == 'tinymce' || empty($chatter_editor) )
                                    ...
                                    <textarea id="body" class="richText" name="body" placeholder="Type Your Discussion Here...">{{ old('body') }}
									</textarea>
		        	...
		        	<ul class="discussions">
		        		@foreach($discussions as $discussion)
				        	<li>
				        		<a class="discussion_list" href="/{{ Config::get('chatter.routes.home') }}/
									{{ Config::get('chatter.routes.discussion') }}/
					        		...
					        		<div class="chatter_middle">
					        			...
					        			<span class="chatter_middle_details">@lang('chatter::messages.discussion.posted_by')
											<span data-href="/user">{{ ucfirst($discussion->user->{Config::get('chatter.user.database_field_with_user_name')}) }}</span>

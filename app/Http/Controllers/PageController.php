...
class PageController extends Controller
{
    ...
    public function blog()
    {
        ...
        return view('frontend.blog.overview', ['articles' => $articles, 'categories' => $categories]);
    }

    /**
     * Show list of articles of exact category
     *
     * @return mixed
     */
    public function category($slug)
    {
        ...
        $articles = $category[0]->articles()->orderBy('created_at', 'desc')->get();
